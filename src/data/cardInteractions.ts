...
export const tutorialCards: Record<string, TutorialCard> = {
  ...
  'new-hire': {
    ...
    type: 'attack',
    description: 'New Hire disables a target Classification card. The classification\'s passive ability stops working.',
    rulesExplanation: 'Play New Hire on any opponent\'s active Classification card. That classification is disabled until a Trained card resolves it. The Supervisor classification auto-resolves New Hire attacks.',
    tags: ['attack', 'disable', 'classification-target'],
    targets: ['facilities', 'field-tech', 'supervisor', 'security-specialist'],
  ...
  'secured': {
    ...
    rulesExplanation: 'Play Secured on a Computer that has been Hacked. The Hacked card is removed and the Computer resumes mining Bitcoin. Also used to counter Audit attacks during Audit Battles.',
  ...
  'trained': {
    ...
    type: 'resolution',
    description: 'Trained resolves a New Hire attack on a Classification card, restoring its passive ability.',
    rulesExplanation: 'Play Trained on a Classification card that has been targeted by New Hire. The New Hire card is removed and the classification\'s ability is restored.',
...
export const cardInteractions: CardInteraction[] = [
  ...
  // ── NEW HIRE interaction ──
  {
    ...
    subtitle: 'Disabling a Classification',
    featuredCardId: 'new-hire',
    complexity: 'medium',
    steps: [
      {
        label: 'Step 1: Target a Classification',
        description: 'An opponent has the Security Specialist active, automatically resolving Hacked attacks.',
      ...
      },
      {
        ...
        description: 'New Hire is placed on the Security Specialist. The classification is disabled — no more auto-resolving.',
        cardIds: ['security-specialist', 'new-hire'],
        stackOrder: ['security-specialist', 'new-hire'],
        highlight: 'new-hire',
        effectLabel: 'DISABLED',
      },
      {
        label: 'Step 3: Resolve with Trained',
        description: 'Play a Trained card to remove the New Hire. The classification ability is restored.',
        cardIds: ['security-specialist', 'new-hire', 'trained'],
        stackOrder: ['security-specialist', 'new-hire', 'trained'],
        highlight: 'trained',
        effectLabel: 'RESOLVING',
      },
      {
        label: 'Step 4: Classification Restored',
        description: 'The New Hire card is removed. The Security Specialist is active again and auto-resolves Hacked attacks.',
        cardIds: ['security-specialist'],
        stackOrder: ['security-specialist'],
        highlight: 'security-specialist',
  ...
  // ── AUDIT battle ──
  {
    ...
    steps: [
      ...
      {
        label: 'Step 2: Defender Counters with Secured',
        description: 'The defender can play a Secured card to block the Audit. If they do, the battle continues.',
        cardIds: ['audit', 'secured'],
        stackOrder: ['audit', 'secured'],
        highlight: 'secured',
        effectLabel: 'BLOCKED',
      },
      {
        label: 'Step 3: Attacker Counters with Hacked',
        description: 'The attacker can play a Hacked card to counter the Secured. The chain goes back and forth.',
        cardIds: ['audit', 'secured', 'hacked'],
        stackOrder: ['audit', 'secured', 'hacked'],
        highlight: 'hacked',
  ...
  // ── AUTO-RESOLVE: Supervisor ──
  {
    ...
    steps: [
      {
        label: 'Step 1: Classification Hit by New Hire',
        description: 'An opponent plays New Hire on your Field Tech. Its bonus move ability is disabled.',
        cardIds: ['field-tech', 'new-hire'],
        stackOrder: ['field-tech', 'new-hire'],
        highlight: 'new-hire',
        effectLabel: 'DISABLED',
      },
      {
        label: 'Step 2: Your Turn Begins',
        description: 'You have an active Supervisor. At the start of your turn, it automatically resolves all New Hire attacks.',
        cardIds: ['field-tech', 'new-hire', 'supervisor'],
        stackOrder: ['field-tech', 'new-hire'],
        highlight: 'supervisor',
        effectLabel: 'AUTO-RESOLVE',
      },
      {
        label: 'Step 3: Classification Restored',
        description: 'The New Hire card is removed automatically. Your Field Tech is active again with its bonus move.',
        cardIds: ['field-tech', 'supervisor'],
