...
const ElectricProgressBar: React.FC<ElectricProgressBarProps> = ({
  segments = [
    { 
      ...
      width: 30,
      icon: (
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="segment-icon">
    ...
    { 
      ...
      width: 30,
      icon: (
        <svg viewBox="0 0 24 24" fill="currentColor" className="segment-icon">
      ...
      <div className="electric-progress-bar-wrapper">
        {segments.map((segment, index) => (
          <React.Fragment key={index}>
            ...
            <div className="progress-icon" style={{ color: segment.color }}>
              {segment.icon}
            </div>
          </React.Fragment>
        ))}
