  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
      <div className="space-y-4">
        <h3 className="text-xl font-semibold font-orbitron text-secondary text-center">Strategic Depth</h3>
      ...
      <div className="space-y-4">
        <h3 className="text-xl font-semibold font-orbitron text-blue-600 text-center">Multiple Paths to Victory</h3>
        <div className="text-center text-muted-foreground leading-relaxed">
