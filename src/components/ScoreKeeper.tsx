...
const characters = [
  ...
  { id: 'facilities', name: 'Facilities', icon: '⚡', image: '/lovable-uploads/classification-facilities-new.png', artwork: '/lovable-uploads/artwork-facilities.png', defaultScale: 0.9 },
