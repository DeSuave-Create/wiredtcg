...
const characters = [
  ...
  { id: 'facilities', name: 'Facilities', icon: '⚡', image: '/lovable-uploads/classification-facilities-new.png', artwork: '/lovable-uploads/artwork-facilities.png', defaultScale: 1.0 },
  ...
  { id: 'analyst', name: 'Analyst', icon: '📊', image: '/lovable-uploads/artwork-analyst.png', artwork: '/lovable-uploads/artwork-analyst.png', defaultScale: 0.9 },
];
