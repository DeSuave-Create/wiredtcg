    ...
    <footer className="border-t neon-border bg-navbar mt-20">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              <Logo />
              <span className="text-xl font-bold font-orbitron text-primary">WIRED</span>
            </div>
        ...
        <div className="border-t border-primary/20 mt-8 pt-8 text-center text-sm text-primary">
          <p>&copy; 2024 <span className="font-orbitron">WIRED</span> Card Game. All rights reserved. | Powered by the Grid.</p>
        </div>
      </div>
    </footer>
  );
